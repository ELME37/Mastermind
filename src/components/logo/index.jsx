  ...
  return (
    <div className='logo'>
        <div className='logo__partie1'>
            ...
            <p className='logo__letter'>c</p>
            <p className='logo__letter'>T</p>
            <p className='logo__letter'>a</p>
            <p className='logo__letter'>c</p>
        </div>
        <div className='logo__partie2'>
            <p className='logo__letter'>B</p>
            <p className='logo__svg'>
